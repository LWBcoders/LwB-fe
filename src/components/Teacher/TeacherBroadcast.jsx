...
export default function TeacherBroadcast() {
  ...
  const [sharingScreen, setSharingScreen] = useState(false); // State for screen sharing
  const [localScreenTrack, setLocalScreenTrack] = useState(null); // State for local screen track
